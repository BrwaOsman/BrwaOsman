        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-right">
                    <a class="mb-2 text-white btn btn-info" id="new-user" data-toggle="modal">New Doctors</a>
                </div>
            </div>
        </div>
        {{-- <script type="text/javascript" src="js2/print.js"></script> --}}
       {{-- <script type="text/javascript" src="http://www.position-absolute.com/creation/print/jquery.printPage.js"></script>
<center> <a href="{{ url('/printD') }}" class="btnprn btn btn-outline-warning">Print </a></center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="userCrudModal">New Doctor</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 ">
                            ...
                            <table class="table-responsive ">
                                ...
                                <tr>
                                    <td></td>
                                    <td style="text-align: right "><a href="{{ route('Doctors.index') }}"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#new-user').click(function () {
            ...
            $('#user').trigger("reset");
            $('#userCrudModal').html("Add New Doctor");
        ...
        $('body').on('click', '#edit-user', function () {
            ...
            $.get('Doctors/' + user_id + '/edit', function (data) {
                $('#userCrudModal').html("Edit Doctor");
        ...
        $('body').on('click', '#delete-user', function () {
            ...
            $.ajax({
                type: "DELETE",
                url: "http://localhost/pharma/public/Doctors/" + user_id,
                data: {
                    "id": user_id,
                    "_token": token,
                },
