...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active btn btn-info">
          <a class="nav-link text-white" data-toggle="modal" data-target=".bd-example-modal-xl" href="#">All Test</a>
        </li>
    ...
    style='width:150px; height:150px; background-color:green; color:white'>
                    ...
                    <h5> {{$item->name}}</h5>
               <input type="checkbox" name="cheack" class="form-control" id="">   
                </button>
